...
Qupath script to dynamically adjust the hematoxylin threshold to correct for batch variation in staining intensity
...
The "baselineThreshold", "hematoxylinIntensityCutoff", "snaIntensityCutoff", and  "circularityCutoff" could be adjusted to develop a novel protocol
...
def hematoxylinIntensityCutoff = 0.07 //default 0.07
...
// calculate dynamic threshold
    ...
    def cells = QP.getCellObjects().findAll { QP.measurement(it, "Nucleus: Hematoxylin OD mean") > hematoxylinIntensityCutoff }
